...
class distributions_MatrixNormal_Kron(Distribution):
  ...
  def __init__(self,
    ...
    ****how to keep track of batches covariance matrices
    ...
    super(distributions_MatrixNormal_Kron, self).__init__(
...
_name = 'MatrixNormal_Kron'
_candidate = distributions_MatrixNormal_Kron
